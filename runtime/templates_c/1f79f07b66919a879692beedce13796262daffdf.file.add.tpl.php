<?php /* Smarty version Smarty-3.0.9, created on 2012-01-22 23:14:54
         compiled from "F:\www\ekonom\application/views/scripts\catalog/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31784f1c35fe4cb261-89683615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '31784f1c35fe4cb261-89683615',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('rub')->value->id==$_smarty_tpl->getVariable('product')->value->rubric->id){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->getVariable('rub')->value->title;?>
            ...
            <tr>
                ...
                <td class="ttovar"><input type="checkbox" style="width: 14px;" name="data[on_first_page]" <?php if ($_smarty_tpl->getVariable('product')->value->onFirstPage){?>checked="checked"<?php }?>"/></td>
            </tr>
